...
const BASE_DISPLAY_TIME = 1700;
const EXPLOSION_TIME = 90;
const CHAR_APPEAR_INTERVAL = 90;
...
class Dot {
  ...
  draw(ctx) {
    ctx.fillStyle = "hsl(330, 100%, 75%)"; // màu hồng nhẹ cho dots
...
function drawMatrixRain() {
  ...
  for (let i = 0; i < drops.length; i++) {
    ...
    ctx.fillStyle = "hsl(330, 100%, 75%)"; // màu hồng nhẹ cho matrix rain
